...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais de un deportista");
		System.out.println("14. Salir de la aplicación\n");
	}

	/*
	 * le pide al usuario un atleta. A conticuacion le muestra la usuario el pais 
	 * que representa dicho atleta
	 */
	private void ejecutarbuscarpais()
	{
		String nombre_atleta = input("Ingrese el nombre del atleta que le interesa");
		System.out.println("el pais del atleta " + nombre_atleta + " es " + calculadora.pais(nombre_atleta));
	}
